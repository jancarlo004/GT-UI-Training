...
export class WCClaimScenario{
    ...
    async WCClaimCreation(){
        ...
        await fnolWizard.fNOLWizardFindPolicyPanelSetpolicyNumber_2.setValue('0715687696');
...
9
        ...
        await workingCompensationWizard.reportedName.selectOptionByLabel('QIwKvovzgg vJtWlgDuAD');
