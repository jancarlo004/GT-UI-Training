...
export class ClaimTabBar {
  ...
  tabBarClaimTabClaimTab_SearchFindClaimButton = PcfButton("#TabBar-ClaimTab-ClaimTab_FindClaim_Button");  
  ...
  claimTabClaimTab_FindClaimInput = PcfTextInput('#TabBar-ClaimTab-ClaimTab_FindClaim');
  ...
  async OpenClaimMenuItem(valuetoEnter) {
    
    await this.tabBarClaimTabMoreOptions.click();
    await this.claimTabClaimTab_FindClaimInput.setValue(valuetoEnter);
    await this.tabBarClaimTabClaimTab_SearchFindClaimButton.click();
  }
}